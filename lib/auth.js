...
/**
 * Resolve the canonical base URL for this deployment. Vercel sets
 * VERCEL_URL to the current deployment's own hostname and
 * VERCEL_PROJECT_PRODUCTION_URL to the stable production domain. Prefer an
 * explicit BETTER_AUTH_URL if one is ever set for a custom domain.
 */
function resolveBaseURL() {
  ...
  return "https://piston-powered-ranch.vercel.app";
}
